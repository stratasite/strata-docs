...
- [Managing Datasources](/cli/datasources) - Add and configure datasources
- [Creating Tables](/cli/tables) - Create semantic table models
- [Deployment](/cli/deployment) - Deploy to the Strata server
