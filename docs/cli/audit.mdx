...
**Check:** Required keys in table and relationship files. See [Tables](/semantic-model/tables) and [Relationships](/semantic-model/relationships/cardinality).
...
- [Deployment](/cli/deployment) - Deploy after audits pass
- [Testing](/cli/tests) - Validate SQL generation
- [CI/CD](/cli/ci-cd) - Automate audits and deployment
