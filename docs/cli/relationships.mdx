...
- Learn about [cardinality types](/semantic-model/relationships/cardinality) in detail
- Understand [join types](/semantic-model/relationships/join-types)
- [Cardinality and join types](/semantic-model/relationships/cardinality)
- Explore [advanced features](/advanced) like multi-datasource queries
