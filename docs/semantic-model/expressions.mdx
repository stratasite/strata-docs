...
- Learn about [relationships](/cli/relationships) to join tables
- Read the [SQL expressions deep-dive](/semantic-model/expressions/sql)
- Explore [lookup expressions](/semantic-model/expressions/lookups)
- Understand [array expressions](/semantic-model/expressions/arrays)
