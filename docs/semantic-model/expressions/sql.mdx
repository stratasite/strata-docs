...
- Learn about [lookup expressions](/semantic-model/expressions/lookups)
- Explore [array expressions](/semantic-model/expressions/arrays)
- Understand [primary keys](/semantic-model/fields/dimensions#primary-keys)
