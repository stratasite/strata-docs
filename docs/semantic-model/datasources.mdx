...
For CLI commands to add, test, and manage datasources, see [datasource](/docs/cli/datasource).
...
1. **PostgreSQL** — [postgres](/docs/cli/adapters/postgres)
2. **Snowflake** — [snowflake](/docs/cli/adapters/snowflake)
3. **MySQL** — [mysql](/docs/cli/adapters/mysql)
4. **SQL Server** — [sqlserver](/docs/cli/adapters/sqlserver)
5. **Athena** — [athena](/docs/cli/adapters/athena)
6. **Trino** — [trino](/docs/cli/adapters/trino)
7. **DuckDB** — [duckdb](/docs/cli/adapters/duckdb)
8. **Druid** — [druid](/docs/cli/adapters/druid)
...
- [datasource](/docs/cli/datasource) — CLI commands
