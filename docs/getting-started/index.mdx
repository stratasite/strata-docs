...
Welcome to Strata Developer Docs! These docs will help you get familiar with the Strata CLI and with building semantic models for Strata.
...
1. **[Install Strata CLI](/getting-started/installation)** — Install the command-line tool on your system
2. **[Core Concepts](/getting-started/concepts)** — Understand semantic layer, tables, relationships, and datasources before you build
3. **[Quickstart](/getting-started/quickstart)** — Build your first semantic model step-by-step (assumes you've read concepts)
...
Ready to get started? [Install Strata CLI](/getting-started/installation), then read [Core Concepts](/getting-started/concepts) and run the [Quickstart](/getting-started/quickstart) to create your first semantic model.
